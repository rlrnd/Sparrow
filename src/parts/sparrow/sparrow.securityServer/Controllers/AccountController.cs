...
using sparrow.securityServer.Models;
using sparrow.securityServer.Models.AccountViewModels;
using sparrow.securityServer.Services;
using IdentityServer4.Services;
using IdentityServer4.Stores;
using Microsoft.AspNetCore.Http.Authentication;
using sparrow.securityServer.Code;
using Microsoft.AspNetCore.Http;

namespace sparrow.securityServer.Controllers
{
    [Authorize]
    [SecurityHeaders]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ClaimType = "rl-sparrow-tenant-id",
                    ClaimValue = "abcd"
                });
